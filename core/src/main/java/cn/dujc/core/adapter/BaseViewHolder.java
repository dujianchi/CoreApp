...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * {@link BaseQuickAdapter#setOnItemChildClickListener(BaseQuickAdapter.OnItemChildClickListener)}
     * <p>
     ...
     * @param viewId
     * @return if you use adapter bind listener
     * {@link BaseQuickAdapter#setOnItemChildLongClickListener(BaseQuickAdapter.OnItemChildLongClickListener)}
     * <p>
     * or if you can use  recyclerView.addOnItemTouch(listerer)  wo also support this menthod
     */
    @SuppressWarnings("unchecked")
    ...
    public void itemMarginLeft(int margin) {
        final ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) itemView.getLayoutParams();
        if (params != null) {
    ...
    public void itemMarginRight(int margin) {
        final ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) itemView.getLayoutParams();
        if (params != null) {
    ...
    public void itemMarginTop(int margin) {
        final ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) itemView.getLayoutParams();
        if (params != null) {
    ...
    public void itemMarginBottom(int margin) {
        final ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) itemView.getLayoutParams();
        if (params != null) {
